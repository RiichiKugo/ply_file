...
var mjpegViewer = new MJPEGCANVAS.Viewer({
                    ...
                    height : Math.round(window.innerWidth * 480/640/2),
                    quality : 10,
...
var pub_msgs = new ROSLIB.Message();

document.getElementById("pub_button").addEventListener("click",function(e){
        e.preventDefault();
        pub_msgs = new ROSLIB.Message({
                rensya : 1
        });
        pub_pub.publish(pub_msgs);
        console.log('mode_select'+mode_select);
